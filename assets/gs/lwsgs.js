...
var lwsgs_auth = parseInt("$lwsgs_auth", 10);
var lwsgs_email = "$lwsgs_email";

/*
 * auth:
 *   b0: LWSGS_AUTH_LOGGED_IN
 *   b1: LWSGS_AUTH_ADMIN
 *   b2: LWSGS_AUTH_VERIFIED
 *   b3: LWSGS_AUTH_FORGOT_FLOW
 */
...
\
       <div id="dwaitverify" class="hiddenr">\
         <table class="r">\
          <tr><td><span id=grav1></span></td>\
 	   <td class="tac"><table><tr><td class="tac">\
		<a href="#" id="clink">\
		<span id="curuser1"></span></a></td></tr><tr>\
           <td class="tac">Awaiting account verification</td>\
          </tr></table></td></tr>\
         </table>\
	</div>\
\
...
function lwsgs_update()
{
	...
	if (lwsgs_user)
		document.getElementById("curuser1").innerHTML = 
	...
	if (lwsgs_user === "")
		...
		if (lwsgs_auth & 4)
			...
			document.getElementById("dwaitverify").style.display = "inline";
	}
 }
...
<!--	document.getElementById('cemail').oninput = cupdate_email;-->
	...
	if (lwsgs_email)
		document.getElementById('grav1').innerHTML =
